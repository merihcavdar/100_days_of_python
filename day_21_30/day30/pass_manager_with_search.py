...
def generate_password():
    letters = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'r', 's',
               't', 'u', 'v', 'y', 'z', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M',
               'N', 'O', 'P', 'R', 'S', 'T', 'U', 'V', 'Y', 'Z']
...
def save():
    ...
    if len(website) == 0 or len(password) == 0:
        messagebox.showinfo(title="ooppss", message="please make sure you entered all the info")
    else:
        try:
...
def find_password():
    ...
    try:
        ...
        if website in data:
            ...
            messagebox.showinfo(title="Result", message=f"No such website is for {website} saved before.")
# ---------------------------- UI SETUP ------------------------------- #
...
email_entry.insert(0, "cavdarmerih@hotmail.com")
